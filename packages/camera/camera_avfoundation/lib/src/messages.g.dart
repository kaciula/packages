...
class PlatformCameraDescription {
  ...
  static PlatformCameraDescription decode(Object result) {
    ...
    return PlatformCameraDescription(
      ...
      availableStabilizationModes: (result[2] as List<Object?>?)!.cast<PlatformCameraStabilizationMode>(),
      captureDeviceType: result[3]! as PlatformAVCaptureDeviceType,
    );
  }
}
...
class CameraApi {
  ...
  Future<int> create(String cameraName, PlatformMediaSettings settings, PlatformCameraStabilizationMode stabilizationMode) async {
    ...
    final List<Object?>? pigeonVar_replyList =
        await pigeonVar_channel.send(<Object?>[cameraName, settings, stabilizationMode]) as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
    } else if (pigeonVar_replyList.length > 1) {
      throw PlatformException(
