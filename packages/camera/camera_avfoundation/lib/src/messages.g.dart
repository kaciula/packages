...
class PlatformCameraDescription {
  ...
  List<PlatformCameraStabilizationMode> availableStabilizationModes;
  ...
  static PlatformCameraDescription decode(Object result) {
    ...
    return PlatformCameraDescription(
      ...
      availableStabilizationModes: (result[3]! as List<Object?>).cast<PlatformCameraStabilizationMode>(),
      captureDeviceType: result[4]! as PlatformAVCaptureDeviceType,
    );
  }
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(name, other.name) && _deepEquals(lensDirection, other.lensDirection) && _deepEquals(lensType, other.lensType) && _deepEquals(availableStabilizationModes, other.availableStabilizationModes) && _deepEquals(captureDeviceType, other.captureDeviceType);
  }
...
class _PigeonCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is int) {
      ...
      buffer.putUint8(138);
      writeValue(buffer, value.index);
    }    else if (value is PlatformCameraStabilizationMode) {
      buffer.putUint8(139);
      writeValue(buffer, value.index);
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 139:
        final value = readValue(buffer) as int?;
        return value == null ? null : PlatformCameraStabilizationMode.values[value];
      case 140:
        final value = readValue(buffer) as int?;
...
class CameraApi {
  ...
  Future<int> create(String cameraName, PlatformMediaSettings settings, PlatformCameraStabilizationMode stabilizationMode) async {
    ...
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(<Object?>[cameraName, settings, stabilizationMode]);
    final pigeonVar_replyList = await pigeonVar_sendFuture as List<Object?>?;
