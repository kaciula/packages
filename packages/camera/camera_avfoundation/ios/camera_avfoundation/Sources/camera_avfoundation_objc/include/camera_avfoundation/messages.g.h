...
typedef NS_ENUM(NSUInteger, FCPPlatformCameraStabilizationMode) {
  /// No stabilization.
  FCPPlatformCameraStabilizationModeOff = 0,
  /// Stabilization using digital video stabilization.
  FCPPlatformCameraStabilizationModeDigital = 1,
  /// Stabilization using optical video stabilization (OIS).
  FCPPlatformCameraStabilizationModeOptical = 2,
  /// A mode that uses the standard algorithm.
  FCPPlatformCameraStabilizationModeStandard = 3,
  /// A mode that uses the cinematic stabilization algorithm.
  FCPPlatformCameraStabilizationModeCinematic = 4,
  /// A mode that uses the extended cinematic stabilization algorithm.
  FCPPlatformCameraStabilizationModeCinematicExtended = 5,
  /// A mode that uses the preview optimized stabilization algorithm.
  FCPPlatformCameraStabilizationModePreviewOptimized = 6,
  /// A mode that indicates the system chooses the most appropriate video stabilization mode for the device and format.
  FCPPlatformCameraStabilizationModeAuto = 7,
};

/// Wrapper for FCPPlatformCameraStabilizationMode to allow for nullability.
@interface FCPPlatformCameraStabilizationModeBox : NSObject
@property(nonatomic, assign) FCPPlatformCameraStabilizationMode value;
...
@property(nonatomic, copy) NSArray<FCPPlatformCameraStabilizationModeBox *> * availableStabilizationModes;
...
- (void)createCameraWithName:(NSString *)cameraName settings:(FCPPlatformMediaSettings *)settings stabilizationMode:(FCPPlatformCameraStabilizationMode)stabilizationMode completion:(void (^)(NSNumber *_Nullable, FlutterError *_Nullable))completion;
