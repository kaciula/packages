...
@implementation FCPPlatformCameraStabilizationModeBox
- (instancetype)initWithValue:(FCPPlatformCameraStabilizationMode)value {
  self = [super init];
  if (self) {
    _value = value;
  }
...
+ (instancetype)makeWithName:(NSString *)name
    ...
    availableStabilizationModes:(NSArray<FCPPlatformCameraStabilizationModeBox *> *)availableStabilizationModes
  ...
  pigeonResult.availableStabilizationModes = availableStabilizationModes;
...
+ (FCPPlatformCameraDescription *)fromList:(NSArray<id> *)list {
  ...
  pigeonResult.availableStabilizationModes = GetNullableObjectAtIndex(list, 2);
  FCPPlatformAVCaptureDeviceTypeBox *boxedFCPPlatformAVCaptureDeviceType = GetNullableObjectAtIndex(list, 3);
...
- (NSArray<id> *)toList {
  return @[
    ...
    self.availableStabilizationModes ?: [NSNull null],
...
- (nullable id)readValueOfType:(UInt8)type {
  switch (type) {
    ...
    case 137: {
      NSNumber *enumAsNumber = [self readValue];
      return enumAsNumber == nil ? nil : [[FCPPlatformCameraStabilizationModeBox alloc] initWithValue:[enumAsNumber integerValue]];
    }
    case 138: {
      NSNumber *enumAsNumber = [self readValue];
...
- (void)writeValue:(id)value {
  if ([value isKindOfClass:[FCPPlatformCameraLensDirectionBox class]]) {
    ...
    [self writeByte:136];
    [self writeValue:(value == nil ? [NSNull null] : [NSNumber numberWithInteger:box.value])];
  } else if ([value isKindOfClass:[FCPPlatformCameraStabilizationModeBox class]]) {
    FCPPlatformCameraStabilizationModeBox *box = (FCPPlatformCameraStabilizationModeBox *)value;
    [self writeByte:137];
    [self writeValue:(value == nil ? [NSNull null] : [NSNumber numberWithInteger:box.value])];
  ...
  /// Create a new camera with the given settings, and returns its ID.
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        ...
        codec:FCPGetMessagesCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(createCameraWithName:settings:stabilizationMode:completion:)], @"FCPCameraApi api (%@) doesn't respond to @selector(createCameraWithName:settings:stabilizationMode:completion:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        ...
        FCPPlatformCameraStabilizationModeBox *boxedFCPPlatformCameraStabilizationMode = GetNullableObjectAtIndex(args, 2);
        FCPPlatformCameraStabilizationMode arg_stabilizationMode = boxedFCPPlatformCameraStabilizationMode.value;
        [api createCameraWithName:arg_cameraName settings:arg_settings stabilizationMode:arg_stabilizationMode completion:^(NSNumber *_Nullable output, FlutterError *_Nullable error) {
          callback(wrapResult(output, error));
        }];
      }];
    } else {
